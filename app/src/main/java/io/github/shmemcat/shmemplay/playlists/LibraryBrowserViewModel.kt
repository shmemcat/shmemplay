...
import io.github.shmemcat.shmemplay.domain.CanonicalAbsolutePrimaryPathPlan
import io.github.shmemcat.shmemplay.domain.M3uWriterV1
import io.github.shmemcat.shmemplay.domain.PlaylistRecipe
import io.github.shmemcat.shmemplay.domain.PlaylistRecipeEvaluatorV1
import io.github.shmemcat.shmemplay.domain.PlaylistRule
import io.github.shmemcat.shmemplay.domain.RecipeEvaluation
...
import io.github.shmemcat.shmemplay.settings.LibraryFolderSettings
    ...
    private fun recoverIfNeeded() {
        ...
        viewModelScope.launch {
            ...
            val blocked = outcomes.firstOrNull {
                it.state == io.github.shmemcat.shmemplay.operations.JournalState.RECOVERY_REQUIRED
            }
            if (blocked != null) {
